...
class supervisor extends CI_Controller
{
	...
	{
		parent::__construct();
		if ($this->session->userdata('masuk_supervisor') != TRUE) {
			$url = base_url('auth');
			redirect($url);
		};
	...
	public function index()
	{
		...
		$this->load->view('backend/supervisor/dashboard/index', $data);
	...
	public function visi_misi()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/dashboard/visimisi', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function jabatan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/jabatan/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function detail_pegawai($id)
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/pegawai/detail', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function akun_pegawai()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/akun/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function reset_password($id)
	{
		...
		redirect('supervisor/akun-pegawai');
	}
	...
	public function lembur_pegawai()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/lembur/lembur', $data);
		$this->load->view('backend/template/footer');
	}
	public function simpan_lembur_pegawai()
	{
		...
		redirect('supervisor/tambah-lembur');
	}
	...
	public function tampil_konfirmasi()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/konfirmasi/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function tampilInput()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/absen-input/input', $data);
		$this->load->view('backend/supervisor/absen-input/input_findicator', $data);
		$this->load->view('backend/template/footer');
	}
			...
			for ($row = 2; $row <= 150; $row++) {
				...
				if (!$this->db->insert('absensi', $data)) {
					...
					if ($db_error['message'] != "") {
						...
						redirect('supervisor/tampil-input');
					}
				}
			}
	...
	public function absen_bulanan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/absenbulanan/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function cetak_absen_bulanan($thn, $bln, $idpeg)
	{
		...
		$data['thn'] = $thn;
		// $this->load->view('backend/template/header', $data);
		$this->load->view('backend/supervisor/absenbulanan/cetak', $data);
	}
	...
	public function detail_absen($id)
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/absenbulanan/detail', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function lembur_bulanan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/lemburbulanan/index', $data);
		$this->load->view('backend/template/footer');
	}
	public function cetak_absen_lembur($thn, $bln)
	{
		...
		$data['blnnya'] = $bln;
		$data['thn'] = $thn;
		$this->load->view('backend/supervisor/lemburbulanan/cetak', $data);
	}
	...
	public function tpp_bulanan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/tpp_bulanan/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function inputPayrol()
	{
		...
		redirect('supervisor/tpp-bulanan');
	}
	public function akumulasi_gaji()
	{
		...
		// redirect('supervisor/tpp-bulanana');
	...
	public function simpan_gaji()
	{
		...
		if ($gaji != null) {
			...
			redirect('supervisor/tpp-bulanan', $data);
		}
	}
	...
	public function laporan_tpp_bulanan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/laporan/laporan_tpp', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function detail_laporan_tpp_bulanan($id_pegawai, $bln, $thn)
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/supervisor/laporan/detail_laporan_tpp', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function hapusPayrol($id)
	{
		...
		$this->db->delete('tb_payrol');
		$this->session->set_flashdata('flash', ' Berhasil Dihapus');
		redirect('supervisor/laporan-tpp-bulanan');
	}
	...
	public function cetak_payrol_pegawai($id)
	{
		...
		$this->load->view('backend/supervisor/laporan/cetak', $data);
	}
}
