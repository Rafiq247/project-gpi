...
class supervisor extends CI_Controller
{
	...
	public function absen_harian()
	{
		...
		$this->load->view('backend/s_template/topbar', $data);
		$this->load->view('backend/s_template/sidebar', $data);
		$this->load->view('backend/supervisor/absensekarang/index', $data);
		$this->load->view('backend/s_template/footer');
	}
	public function konfirmasi_absen()
	{
		...
		$this->load->view('backend/s_template/topbar', $data);
		$this->load->view('backend/s_template/sidebar', $data);
		$this->load->view('backend/supervisor/konfirmasi_absen/index', $data);
		$this->load->view('backend/s_template/footer');
	}
	...
	public function absen_bulanan()
	{
		...
		if (empty($this->input->post('th'))) {
			$data['absen'] = $this->supervisor_model->getAbsensiUser($id_peg);
		} else {
			$data['absen'] = $this->supervisor_model->getAllUserAbsensi($thnpilihan1, $thnpilihan2, $id_peg);
		}
		$data['blnnya'] = $bln;
		$data['thn'] = $thn;
		...
		$this->load->view('backend/s_template/topbar', $data);
		$this->load->view('backend/s_template/sidebar', $data);
		$this->load->view('backend/supervisor/absen_bulanan/index', $data);
		$this->load->view('backend/s_template/footer', $data);
	}
	public function detail_absen($id)
	{
		...
		$this->load->view('backend/s_template/topbar', $data);
		$this->load->view('backend/s_template/sidebar', $data);
		$this->load->view('backend/supervisor/absen_bulanan/detail', $data);
		$this->load->view('backend/s_template/footer', $data);
	}
