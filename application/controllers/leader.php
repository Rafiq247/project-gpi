...
class leader extends CI_Controller
{
	...
	public function jabatan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/jabatan/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function akun_pegawai()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/akun/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function lembur_pegawai()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/lembur/lembur', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function tampil_konfirmasi()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/konfirmasi/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function tampilInput()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/absen-input/input', $data);
		$this->load->view('backend/leader/absen-input/input_findicator', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function absen_bulanan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/absenbulanan/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function cetak_absen_bulanan($thn, $bln, $idpeg)
	{
		...
		$data['thn'] = $thn;
		// $this->load->view('backend/template/header', $data);
		$this->load->view('backend/leader/absenbulanan/cetak', $data);
	}
	...
	public function detail_absen($id)
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/absenbulanan/detail', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function lembur_bulanan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/lemburbulanan/index', $data);
		$this->load->view('backend/template/footer');
	}
	public function cetak_absen_lembur($thn, $bln)
	{
		...
		$data['blnnya'] = $bln;
		$data['thn'] = $thn;
		$this->load->view('backend/leader/lemburbulanan/cetak', $data);
	}
	...
	public function tpp_bulanan()
	{
		...
		$this->load->view('backend/template/topbar', $data);
		$this->load->view('backend/template/sidebar', $data);
		$this->load->view('backend/leader/tpp_bulanan/index', $data);
		$this->load->view('backend/template/footer');
	}
	...
	public function simpan_gaji()
	{
		...
		if ($gaji != null) {
			...
			redirect('leader/tpp-bulanan', $data);
		}
	}
	...
	public function hapusPayrol($id)
	{
		...
		$this->db->delete('tb_payrol');
		$this->session->set_flashdata('flash', ' Berhasil Dihapus');
		redirect('leader/laporan-tpp-bulanan');
	}
