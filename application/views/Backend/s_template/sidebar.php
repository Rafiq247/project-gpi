     ...
     <div class="inner-sidebar mr-3">
       ...
       <div class="sidebar-menu-container">
         <ul class="sidebar-menu mt-4 mb-4">
           <li class="parent">
             <a href="<?= base_url() ?>supervisor" class=""><i class="fa fa-dashboard mr-3"> </i>
           ...
           <!-- <li class="parent">
             ...
             <ul class="children" id="tentang">
               <li class="child"><a href="<?= base_url() ?>supervisor/visi_misi" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Visi & Misi</a></li>
               <li class="child"><a href="<?= base_url() ?>supervisor/sejarah" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Sejarah Perusahaan</a></li>
             </ul>
           </li> -->
           <li class="parent">
             ...
             <ul class="children" id="datamaster">
               <li class="child"><a href="<?= base_url() ?>supervisor/pegawai" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Informasi Pegawai</a></li>
             </ul>
           </li>
           <li class="parent">
             ...
             <ul class="children" id="absensi">
               ...
               <!-- <li class="child"><a href="<?= base_url() ?>supervisor/konfirmasi-absen" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Konfirmasi Absen</a></li> -->
             </ul>
           </li>
           <li class="parent">
             ...
             <ul class="children" id="konfirmasi">
               <li class="child"><a href="<?= base_url() ?>supervisor/konfirmasi_leader" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Konfirmasi Izin Absen Leader</a></li>
               <li class="child"><a href="<?= base_url() ?>supervisor/data_pegawai" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Konfirmasi Izin Absen Pegawai</a></li>
             </ul>
           </li>
           <li class="parent">
             ...
             <ul class="children" id="tunjangan">
               <li class="child"><a href="<?= base_url() ?>supervisor/laporan-tpp-bulanan" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Rincian Gaji Anda</a></li>
               <li class="child"><a href="<?= base_url() ?>supervisor/absen-bulanan" class="ml-4"><i class="fa fa-angle-right mr-2"></i>Rincian Absen Anda</a></li>
             </ul>
           </li>
           <li class="parent">
