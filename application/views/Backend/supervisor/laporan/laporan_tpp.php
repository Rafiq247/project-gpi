 							...
 							<?php
								foreach ($gaji as $b) : ?>
 								<tr>
 									...
 									<td width="20px">
 										<a href="<?= base_url('supervisor/detail-laporan-tpp') ?>/<?= $b['id_pegawai']; ?>/<?= $blnselected; ?>/<?= $thnselected; ?>" class="ml-3 mb-0">
 									...
 									<td>
 										<a target="_blank" href="<?= base_url(); ?>supervisor/cetak-payrol-pegawai/<?= $b['id_payrol']; ?>/<?php echo $blnnya  ?>/<?php echo $thn  ?>" class="ml-0">
 									...
 									<td>
 										<a href="<?= base_url(); ?>supervisor/hapus-payrol/<?= $b['id_payrol']; ?>" class="ml-0">
 											<button type="button" class="btn btn-danger">
