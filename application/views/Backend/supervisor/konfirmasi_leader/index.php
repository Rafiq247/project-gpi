 							...
 							<td>
 								<div class="d-flex justify-content-start">
 									<?php
										...
										?>
 										<a class="btn btn-theme" href="<?= base_url('supervisor/acc-izin') ?>/<?= $b['id']; ?>" style="color:white" onclick="return confirm('Yakin Ingin Menizinkan?');"><i class="fas fa-check"></i></a>
 										<a class="btn btn-danger ml-3 trigger-tolak" data-id-izin="<?= $b['id']; ?>" style="color:white"><i class="fas fa-ban"></i></a>
 									<?php
										} elseif ($b['acc'] == 3) {
										?>
 										<a class="btn btn-danger" href="<?= base_url('supervisor/hapus-izin') ?>/<?= $b['id']; ?>" onclick="return confirm('Yakin Ingin Membatalkan?');"><i class="fas fa-times text-light"></i></a>
 									<?php
										}
										?>
 								</div>
