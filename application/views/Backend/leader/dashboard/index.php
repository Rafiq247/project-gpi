     ...
     <div class="modal-dialog ">
       <div class="modal-content">
         ...
         <div class="modal-body text-justify">
           <form class="form-horizontal" action="<?php echo base_url() . 'leader/edit-profil' ?>/<?= $user['id'] ?>" method="post" enctype="multipart/form-data">
             <div class="modal-body">
               ...
               <div class="form-group">
                 ...
                 <div class="col-sm-12">
                   <input type="text" name="role_id" class="form-control " value="<?= $user['role_id'] ?>" readonly>
                 </div>
               </div>
               <div class="form-group">
     ...
     <div class="modal-dialog ">
       <div class="modal-content">
         ...
         <div class="modal-body text-justify">
           ...
           <form class="form-horizontal" action="<?php echo base_url() . 'leader/edit-password' ?>/<?= $user['id'] ?>" method="post" enctype="multipart/form-data">
             <div class="modal-body">
               <div class="form-group">
