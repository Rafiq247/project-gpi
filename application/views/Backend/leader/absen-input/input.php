 					...
 					<?php
						foreach ($absensi as $b) : ?>
 						<tr>
 							...
 							<td>
 								<a class="btn btn-danger ml-1" href="<?= base_url('leader/hapus-input-absen') ?>/<?= $b['id']; ?>" onclick="return confirm('Yakin Ingin Menghapus?');">Hapus</a>
 							</td>
 						</tr>
 					<?php endforeach ?>
 				</tbody>
 				...
 				<div class="modal-dialog modal-lg">
 					<div class="modal-content">
 						...
 						<div class="modal-body text-justify">
 							<form class="form-horizontal" action="<?php echo base_url() . 'leader/edit-absensi' ?>" method="post" enctype="multipart/form-data">
 		...
 		<div class="modal fade" id="inputModal" tabindex="-1" role="dialog" aria-labelledby="inputModalLabel">
 			<div class="modal-dialog modal-lg">
 				<div class="modal-content">
 					...
 					<div class="modal-body text-justify">
 						<form class="form-horizontal" action="<?php echo base_url() . 'leader/input-absensi' ?>" method="post" enctype="multipart/form-data">
 							<div class="modal-body">
 								<div class="form-group">
