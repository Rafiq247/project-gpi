 					...
 					<?php
						foreach ($fingerprint as $b) : ?>
 						<tr>
 							...
 							<td>
 								<a class="btn btn-danger ml-1" href="<?= base_url('leader/hapus-fingerprint') ?>/<?= $b['id']; ?>" onclick="return confirm('Yakin Ingin Menghapus?');">Hapus</a>
 							</td>
 						</tr>
 					<?php endforeach ?>
 				</tbody>
 			...
 			<div class="modal-dialog modal-lg">
 				<div class="modal-content">
 					...
 					<div class="modal-body text-justify">
 						<form class="form-horizontal" action="<?php echo base_url() . 'leader/input-fingerprint' ?>" method="post" enctype="multipart/form-data">
 			...
 			<div class="modal fade" id="editfingerprintmodal<?= $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editfingerprintmodal<?= $value['id']; ?>">
 				<div class="modal-dialog modal-lg">
 					<div class="modal-content">
 						...
 						<div class="modal-body text-justify">
 							<form class="form-horizontal" action="<?php echo base_url() . 'leader/edit-fingerprint' ?>" method="post" enctype="multipart/form-data">
 								<div class="modal-body">
 									<div class="form-group">
 										<label class="col-sm-12">ID Pegawai</label>
 										<div class="col-sm-12">
