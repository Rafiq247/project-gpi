 	...
 	<div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
 								...
 								<?php
									foreach ($a as $b) : ?>
 									<tr>
 										...
 										<td>
 											<form action="<?= base_url() ?>leader/input-data-tpp" method="post">
 			...
 			<div class="modal-dialog modal-lg">
 				<div class="modal-content">
 					...
 					<div class="modal-body text-justify ">
 						...
 						<form class="form-horizontal" action="<?php echo base_url() . 'leader/simpan-gaji' ?>" method="post">
 		...
 		<script>
 			...
 			function cari() {
 				...
 				$.ajax({
 					url: '<?= base_url() ?>leader/akumulasi-gaji',
 					type: 'POST',
 					dataType: 'JSON',
 					data: {
