 						...
 						<tr>
 							...
 							<td>
 								<div class="d-flex justify-content-start">
 									<?php
										if ($b['acc'] == 3 || $b['acc'] == 5 || $b['acc'] == 6 || $b['acc'] == 7 || $b['acc'] == 8 || $b['acc'] == 9) {
										?>
 										<a class="btn btn-theme" href="<?= base_url('admin/acc-izin-leader') ?>/<?= $b['id']; ?>" style="color:white" onclick="return confirm('Yakin Ingin Menizinkan?');"><i class="fas fa-check"></i>
 										</a>
 										<a class="btn btn-danger ml-3 trigger-tolak" data-id-izin="<?= $b['id']; ?>" style="color:white"><i class="fas fa-ban"></i>
 										</a>
 									<?php
										} elseif ($b['acc'] == 1) {
										?>
 										<a class="btn btn-danger ml-1" href="<?= base_url('admin/hapus-izin-leader') ?>/<?= $b['id']; ?>" onclick="return confirm('Yakin Ingin Membatalkan?');"><i class="fas fa-times text-light"></i>
 										</a>
 									<?php
										}
										?>
