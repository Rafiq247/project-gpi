   ...
   <div class="mt-4 mb-4 p-3 bg-white border shadow-sm lh-sm">
                 ...
                 <?php
                  foreach ($a as $b) : ?>
                   <tr>
                     ...
                     <td><?= $key; ?></td>
                     <td><?= $b['jabatan']; ?></td>
                     <td><?php echo 'Rp ' . number_format($b['gaji_pokok'], 2, ',', '.'); ?></td>
                     ...
                     <td>
                       <form action="<?= base_url() ?>supervisor/input-data-tpp" method="post">
       ...
       <div class="modal-dialog modal-lg">
         <div class="modal-content">
           ...
           <div class="modal-body text-justify ">
             ...
             <form class="form-horizontal" action="<?php echo base_url() . 'supervisor/simpan-gaji' ?>" method="post">
     ...
     <script>
       ...
       function cari() {
         ...
         $.ajax({
           url: '<?= base_url() ?>supervisor/akumulasi-gaji',
           type: 'POST',
           dataType: 'JSON',
           data: {
